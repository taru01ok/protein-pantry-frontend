...
export default function Login() {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={{ position: 'absolute', fontSize: '100px', opacity: 0.07, top: '10%', left: '5%' }}>🌿</div>
      <div style={{ position: 'absolute', fontSize: '80px', opacity: 0.07, bottom: '10%', right: '5%' }}>🥗</div>
      <div style={{ position: 'absolute', fontSize: '60px', opacity: 0.06, top: '50%', right: '15%' }}>🌱</div>

      <div style={styles.card}>
        <div style={styles.iconWrap}>🥗</div>
        <h1 style={styles.title}>Protein Pantry</h1>
        <p style={styles.subtitle}>Track your protein staples with ease 🌿</p>
        ...
        <p style={styles.link}>
          Don't have an account? <Link to="/register" style={{ color: '#2c5f2d', fontWeight: '700' }}>Register</Link>
        </p>
      </div>
    </div>
  );
...
const styles = {
  ...
  blob1: {
    ...
    top: '-150px', left: '-150px', animation: 'none'
  },
  blob2: {
  ...
  iconWrap: {
    fontSize: '52px', textAlign: 'center', marginBottom: '8px',
    display: 'block'
  },
  title: { textAlign: 'center', color: '#1a3a1a', marginBottom: '4px', fontSize: '30px', fontWeight: '800' },
  ...
  button: {
    ...
    boxShadow: '0 6px 20px rgba(44,95,45,0.45)',
